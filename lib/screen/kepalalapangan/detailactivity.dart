...
class DetailBerandaKepalaScreen extends StatefulWidget {
  final String id;
  final Chief activity;
  const DetailBerandaKepalaScreen(
      {Key? key, required this.id, required this.activity})
      : super(key: key);

  @override
  State<DetailBerandaKepalaScreen> createState() =>
      _DetailBerandaKepalaScreenState();
}

class _DetailBerandaKepalaScreenState extends State<DetailBerandaKepalaScreen> {
