...
class RiwayatStatusPekerja extends StatefulWidget {
  const RiwayatStatusPekerja({Key? key}) : super(key: key);

  @override
  State<RiwayatStatusPekerja> createState() => _RiwayatStatusPekerjaState();
}

class _RiwayatStatusPekerjaState extends State<RiwayatStatusPekerja> {
  @override
